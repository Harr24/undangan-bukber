...
export default function Lokasi() {
  return (
    <section id="lokasi" className="max-w-4xl mx-auto px-4 mt-12 md:mt-20 pt-8 text-center">
      <h2 className="text-2xl md:text-4xl font-bold text-emerald-800 mb-3 md:mb-6">
        Tempat Perkara
      </h2>

      {/* Teks sudah diganti jadi lawak */}
      <p className="font-bold text-lg md:text-2xl text-emerald-700 mb-1">Opsi Kuat Mas R </p>
      ...
      <div className="w-full h-64 md:h-96 lg:h-[450px] bg-gray-200 rounded-2xl shadow-inner overflow-hidden border-2 md:border-4 border-emerald-100 relative">
